        ...
        regular_rich_text_areas.each(function() {
            ...
            richTextArea.on('hallomodified', function(event, data) {
                ...
                if (isFinite(readingAge)) {
                    ...
                    richTextParent.find('div.help').html("<strong>Reading age:</strong> " + readingAge);
                }
                else {
                    richTextParent.find('div.help').html("<strong>Reading age:</strong> Not enough content to calculate age score.");
                }
            });
        });
    }
