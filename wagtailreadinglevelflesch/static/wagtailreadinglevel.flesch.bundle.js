    ...
    window.draftail.registerPlugin(
      {
        ...
        meta: function (e) {
          var i,
            ...
            n,
            s =
              ((i = (0, e.getEditorState)().getCurrentContent().getPlainText()),
              (r = i
                .replace(/[^a-zA-Z ]/g, "")
                .split(" ")
                .filter(function (e) {
              ...
              (o = (function (e) {
                ...
                let r = -1,
                  o = 0;
                for (; ++r < i.length; ) o += d(i[r].replace(/[^a-z]/g, ""));
                return o;
              })(i)),
              (n =
                206.835 -
                (r /
                  (i.replace(/\S[.?!](\s|$)/g, "$1|").split("|").length - 1)) *
                  1.015 -
                (o / r) * 84.6),
            ...
            l = "tb-indicator";
          return s
            ? ((t = "Flesch Score: ".concat(s.score)),
              window.React.createElement("div", { className: l }, t))
            : window.React.createElement("div", { className: l }, "".concat(t));
        },
      },
      "controls"
    );
